...
namespace CancionesWeb.Controllers
{
    public class CancionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CancionID,Name,Author,Lyrics,URL")] Canciones canciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CancionID,Name,Author,Lyrics,URL")] Canciones canciones)
        {
